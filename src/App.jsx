  ...
  return (
    <div className="font-sans bg-white text-gray-900">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-600 text-white py-16 px-4 text-center">
        <h1 className="text-4xl font-bold mb-4">JSingh Law</h1>
        <p className="text-xl mb-6">Personal, business, and family legal services in Surrey, BC</p>
      ...
      <section className="max-w-3xl mx-auto py-12 px-4 text-center">
        ...
        <p className="mb-4">
          JSingh Law offers comprehensive legal support for individuals, families, and businesses. With a focus on results, integrity, and accessible service, we guide you through real estate, wills, immigration, corporate law, and more.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto py-12 px-4 flex flex-col md:flex-row items-center gap-8">
        ...
        />
        <div>
          <h2 className="text-2xl font-bold mb-2">Jaspreet Singh, Lawyer</h2>
          <p>
            Jaspreet Singh is dedicated to delivering high-quality legal solutions with a client-first approach. With years of experience across multiple practice areas, Jaspreet is committed to providing clear guidance and strong advocacy for every client.
          </p>
        </div>
      </section>
